...
{
    [TestClass]
    public class MyOptimizedDictionaryTests
    {
        ...
        public void Initialize()
        {
            ...
            dict = new MyOptimizedDictionary<int, char>(pairs);
            otherDict = new MyOptimizedDictionary<int, char>();
        }
        ...
        public void AddAlreadyContainedPair()
        {
            ...
            int i = 0;
            foreach (var pair in (MyOptimizedDictionary<int, char>)otherDict)
            {
        ...
        {
            var intDict = new MyOptimizedDictionary<int, int>();
